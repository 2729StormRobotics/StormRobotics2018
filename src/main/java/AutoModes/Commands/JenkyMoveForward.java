...
public class JenkyMoveForward extends Command {
     ...
     */
    public JenkyMoveForward(double _dist) {
        //requires(robot.navx);
        distance = _dist;
    }
    ...
    protected boolean isFinished() {
        ...
        */
        ...
        if (Math.abs(moveLeftController.getError()) < (Constants.TOLERANCE_TICKS + inchesToTicks(10)) && Math.abs(moveRightController.getError()) < Constants.TOLERANCE_TICKS + inchesToTicks(10)) {
            moveLeftController.disable();
            moveRightController.disable();
            angleController.disable();
